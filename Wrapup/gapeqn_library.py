"""
A library of functions for Pade decomposition and solving the gap equations. Part of the code on solving the gap equations is legacy of Max. Knight_shift() and specific_heat() calculates the thermodynamic properties by analytic continuation. A fully thermodynamic implementation is given in the Jupyter notebook.
"""
