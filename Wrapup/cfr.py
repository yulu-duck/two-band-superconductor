...
"""
this part of code is from https://github.com/freude/Continued-fraction-representation 
"""
...
class CFR(object):
    ...
    def integrate(self, gf, ef=0, tempr=300, t_ordered=False):
        """
        ...
        if t_ordered:
            ...
            val_inf = 1.0e10
            zero_moment = 1j * val_inf * gf(1j * val_inf)
